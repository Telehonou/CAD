...
<script type="text/javascript" src="./interface/Module/liste.js"></script>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div style="display: none" id="code_grp1" class="form-group">
                            <label for="code_grp1">
                                GroupeCode</label>
                            <select name="categorie"  name="mod_modulegroupcode" id="modulegroupcode"  class="form-control"  >
                                                    <option value=""></option>
                                                    
                            </select>  
                            <select id="confirme"></select>
                        </div>
                        <div class="form-group" style="display: none" id="name_grp">
                            <label for="name_grp">
                                GroupeName</label>
                        ...
                        <div class="form-group" style="display: none" id="code_mod1">
                            <label for="cod_mod">
                                ModuleCode</label>
                            <input type="text" name="mod_modulecode" id="mod_modulecode"  class="form-control" placeholder="Ex: DOC(documents)"></input>
                        </div>
