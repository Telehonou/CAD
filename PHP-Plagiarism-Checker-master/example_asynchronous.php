...
$email = 'otsafack@yahoo.fr';
$apiKey = 'c12fb1fa-81d5-4d5d-ad4c-44ebaffbf7fd';
...
try{
	...
	$additionalHeaders = array($clConst['SANDBOX_MODE_HEADER'], // Sandbox mode - Scan without consuming any credits and get back dummy results
		//$additionalHeaders = array($clConst['HTTP_CALLBACK'].': http://localhost/CADN/' 
                                $clConst['HTTP_CALLBACK'].':http:localhost/CADN/' # For a fast testing of callbacks option we recommend to use http://requestb.in
